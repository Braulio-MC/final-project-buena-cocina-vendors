...
@Composable
fun StoreUpdateInformationScreen(
    ...
    StoreUpdateInformationScreenContent(
        windowSizeClass = windowSizeClass,
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun StoreUpdateInformationScreenContent(
    windowSizeClass: WindowSizeClass,
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(id = R.string.store_update_information_screen_title),
                        fontSize = 23.sp,
        ...
        Column(
            ...
            val restrictions = listOf(
                stringResource(
                    id = R.string.store_update_information_screen_name_restriction,
                    STORE_REGISTRATION_MINIMUM_STORE_NAME_LENGTH,
                    STORE_REGISTRATION_MAXIMUM_STORE_NAME_LENGTH
                ),
                stringResource(
                    id = R.string.store_update_information_screen_desc_restriction,
                    STORE_REGISTRATION_MINIMUM_STORE_DESCRIPTION_LENGTH,
                    STORE_REGISTRATION_MAXIMUM_STORE_DESCRIPTION_LENGTH
                ),
                stringResource(
                    id = R.string.store_update_information_screen_email_restriction,
                    MAXIMUM_EMAIL_LENGTH
                ),
                stringResource(
                    id = R.string.store_update_information_screen_phone_restriction,
                    MAXIMUM_PHONE_NUMBER_LENGTH
                ),
                stringResource(id = R.string.store_update_information_screen_active_orders_restriction)

            )
            val recommendations = listOf(
                stringResource(id = R.string.store_update_information_screen_image_recommendation1),
                stringResource(id = R.string.store_update_information_screen_image_recommendation2),
            )
            Spacer(modifier = Modifier.padding(top = 16.dp))
            Text(
                text = stringResource(id = R.string.store_update_information_screen_considerations),
                fontSize = 26.sp,
            ...
            Spacer(modifier = Modifier.padding(top = 16.dp))
            Text(
                text = stringResource(id = R.string.store_update_information_screen_recommendations),
                fontSize = 26.sp,
                fontWeight = FontWeight.SemiBold,
            )
            Spacer(modifier = Modifier.padding(top = 12.dp))
